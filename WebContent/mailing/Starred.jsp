<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
	<%@include file="static.jsp" %>
		<div class="container" id="starred">
		<form action="StarredControlServlet" method="get">
        	...
        	<div class="content">
        	  <%	
        	  try{
        	  	Map<Long,ArrayList<String>> mail = (Map<Long, ArrayList<String>>)request.getAttribute("starred");
        	 	Set set = mail.keySet();
        	  	...
        	  	while(t.hasNext()) {
        			...
        			<a href="<%=request.getContextPath() %>/OpenStarredMessageServlet?id=<%=key%>">
